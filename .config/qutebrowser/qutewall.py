...
if os.path.isfile(colors_absolute):
    ...
    c.colors.contextmenu.menu.bg = colors['special']['background']
    c.colors.contextmenu.menu.fg = colors['special']['foreground']

    c.colors.contextmenu.selected.bg = colors['colors']['color4']
    c.colors.contextmenu.selected.fg = colors['special']['background']

    c.colors.contextmenu.disabled.bg = colors['colors']['color8']
    c.colors.contextmenu.disabled.fg = colors['special']['background']
    ...
    # for transparency.
    # Type: QssColor
    c.colors.hints.bg = colors['colors']['color4']
    ...
    # Type: QssColor
    c.colors.messages.error.bg = colors['colors']['color2']
    ...
    # Type: QssColor
    c.colors.statusbar.insert.bg = colors['colors']['color8']
